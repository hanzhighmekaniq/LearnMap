<div class="bg-[#4F7F81]">
    <nav class="border-gray-200 container bg-[#4F7F81]">
        <div class="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <button data-collapse-toggle="navbar-solid-admin" type="button"
                ...
                aria-controls="navbar-solid-admin" aria-expanded="false">
            ...
            <div class="hidden w-full md:block md:w-auto py-4" id="navbar-solid-admin">
                <ul
                    ...
                    <li class="">
                        <button type="button"
                            ...
                            id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dd"
